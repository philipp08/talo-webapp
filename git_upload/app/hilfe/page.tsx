      ...
      <section className="relative pt-[160px] pb-12 lg:pb-20 border-b border-gray-100 dark:border-white/5">
        <div className="max-w-6xl mx-auto px-6 w-full">
          <ScrollReveal direction="up" delay={0.1}>
             <span className="text-[11px] font-bold tracking-[0.2em] text-[#34C759] uppercase mb-4 block">HILFECENTER</span>
             <h1 className="text-[3rem] md:text-[4.5rem] font-medium tracking-tight font-logo text-gray-950 dark:text-white mb-8 leading-[1.05]">
                Wie können wir<br />euch heute <span className="text-[#34C759] italic">unterstützen?</span>
             </h1>
          </ScrollReveal>
          ...
          <ScrollReveal direction="up" delay={0.25}>
            <div className="max-w-xl relative group">
              <input 
                ...
                className="w-full px-6 py-5 rounded-2xl bg-gray-50 border border-gray-200 dark:bg-white/5 dark:border-white/10 dark:text-white focus:outline-none focus:ring-4 focus:ring-[#34C759]/10 transition-all pl-14 font-medium"
              />
          ...
          <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <button 
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all font-medium ${
                        activeSection === section.id 
                          ? "bg-[#34C759]/10 text-[#34C759] dark:bg-white/5 dark:text-white" 
                          : "text-gray-500 dark:text-[#8A8A8A] hover:bg-gray-50 dark:hover:bg-white/[0.03] hover:text-black dark:hover:text-white"
                      }`}
                    >
                      <div className={`p-2 rounded-lg transition-colors ${activeSection === section.id ? "bg-[#34C759]/20" : "bg-gray-100 dark:bg-white/5"}`}>
                        {section.icon}
                      </div>
            ...
            <div className="lg:w-3/4 flex flex-col gap-24">
               {sections.map((section) => (
                 <div key={section.id} id={section.id} className="scroll-mt-32">
                    <div className="flex items-center gap-4 mb-10 pb-4 border-b border-gray-100 dark:border-white/5">
                       <div className="w-12 h-12 rounded-2xl bg-[#34C759] flex items-center justify-center text-white">
                          {section.icon}
                       </div>
                    ...
                    <div className="grid md:grid-cols-1 gap-10">
                       {section.items.map((item, j) => (
                         <div key={j} className="group flex flex-col gap-3">
                            <h4 className="text-[18px] font-bold text-gray-900 dark:text-white group-hover:text-[#34C759] transition-colors">
                               {item.q}
                            </h4>
               ...
               <div className="bg-[#080808] dark:bg-[#101010] rounded-[40px] p-8 md:p-14 text-center mt-12 relative overflow-hidden border border-white/5">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-[#34C759]/10 rounded-full blur-[80px] -mr-32 -mt-32" />
        ...
        <div className="max-w-6xl mx-auto px-6">
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="p-8 rounded-[32px] bg-gray-50 dark:bg-[#0c0c0c] border border-gray-100 dark:border-white/5 hover:border-[#34C759]/30 transition-all cursor-pointer group">
