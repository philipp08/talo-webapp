               ...
               <div className="bg-[#080808] dark:bg-[#101010] rounded-[40px] p-8 md:p-14 text-center mt-12 relative overflow-hidden border border-white/5">
                  ...
                  <div className="relative z-10">
                     ...
                     <div className="flex flex-wrap items-center justify-center gap-4">
                        <a href="mailto:philipp@pauli-one.de" className="flex items-center gap-2 px-8 py-4 rounded-full bg-white text-black font-bold hover:scale-105 transition-all">
                           <Mail size={18} /> philipp@pauli-one.de
                        </a>
