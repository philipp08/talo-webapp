    ...
    <main className="relative min-h-screen bg-white dark:bg-[#080808]">
      ...
      <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 md:pt-48 md:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 text-center relative z-10">
          <h1 className="text-[1.9rem] leading-[1.1] sm:text-[3.5rem] md:text-[5rem] lg:text-[6.5rem] font-medium tracking-[-0.04em] font-logo mb-6 sm:mb-8 max-w-6xl mx-auto [word-break:break-word] text-gray-950 dark:text-white">
            ...
            <div className="flex-1 w-full order-2 lg:order-1">
              <ScrollReveal direction="left" duration={0.8}>
                <div className="bg-[#F0EBFF] dark:bg-[#211D2E] rounded-[28px] sm:rounded-[40px] p-6 sm:p-8 md:p-12 overflow-hidden flex justify-center">
                  <div className="scale-75 sm:scale-90 md:scale-100 origin-top">
                    <PhoneDemo initialScreen="dashboard" />
                  </div>
                </div>
              </ScrollReveal>
            </div>
      ...
      {/* ─── NEWS / BLOG SECTION ────────────────────────────────── */}
      <section className="py-20 sm:py-32 bg-gray-50 dark:bg-[#0c0c0c]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <ScrollReveal direction="up" duration={0.8}>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16">
              <div>
                <h2 className="text-[2rem] sm:text-[2.5rem] md:text-[3.5rem] font-medium tracking-tight text-gray-900 dark:text-white leading-[1.1] mb-4">
                  Neues von Talo
                </h2>
                <p className="text-base sm:text-xl text-gray-500 dark:text-gray-400 font-medium max-w-xl">
                  Updates, Insights und Best-Practices für modernes Vereinsmanagement.
                </p>
              </div>
              <Link href="/blog" className="text-[#34C759] font-bold flex items-center gap-2 hover:gap-3 transition-all">
                Alle Artikel lesen <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              {
                title: "Warum Talo? Die Vision hinter modernem Engagement",
                excerpt: "Warum wir glauben, dass Engagement wichtiger ist als reine Finanzverwaltung und wie Talo das Ehrenamt verändert.",
                date: "24. März 2026",
                category: "Insights",
                link: "/blog/vision",
              ...
              {
                title: "Die 5 besten Strategien für Mitgliederbindung",
                excerpt: "Wie ihr mit kleinen Anpassungen in eurem Workflow die Aktivität in eurem Verein massiv steigern könnt.",
                date: "18. März 2026",
              ...
              <ScrollReveal key={i} direction="up" delay={i * 0.1} duration={0.8}>
                <Link href={post.link} className="group flex flex-col h-full bg-white dark:bg-[#121212] rounded-[32px] p-8 border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10 transition-all">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 leading-snug group-hover:text-[#34C759] transition-colors">
                    {post.title}
                  </h3>
