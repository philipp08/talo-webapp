    ...
    <div className="flex flex-col w-full gap-7 px-5 pt-4 pb-28 relative z-10">
      ...
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-1">
          <h1 className="text-[26px] font-bold text-white leading-tight tracking-tight font-logo italic">Hey, Philipp 👋</h1>
      ...
      <div className="grid grid-cols-2 gap-3.5">
        {[
          ...
          { value: "118", label: "ON TRACK", icon: <CheckCircle size={16} />, color: "#34C759" },
          ...
          >
            ...
            <div className="flex flex-col gap-0.5">
              <p className="text-[26px] font-bold text-white leading-none font-logo italic">{s.value}</p>
      ...
      <div className="flex flex-col gap-4">
        ...
        <GlassSection>
          {[
            { name: "Lukas K.", pts: 72, target: 80, color: "#34C759" },
            { name: "Sarah M.", pts: 45, target: 80, color: "#FF9500" },
            { name: "Tom H.", pts: 89, target: 80, color: "#34C759" },
          ].map((m, i) => (
            <div key={i}>
       ...
       >
          <div className="relative">
             ...
             <div className="w-[100px] h-[100px] rounded-full bg-green-500/10 border border-green-500/20 flex items-center justify-center relative">
                <CheckCircle size={48} className="text-[#34C759]" strokeWidth={1.5} />
             </div>
          </div>
  ...
  return (
    <div className="flex flex-col w-full gap-7 px-5 pt-4 pb-28 relative z-10">
       <div className="flex items-end justify-between px-1">
          <h1 className="text-[26px] font-bold text-white leading-tight tracking-tight font-logo italic">Rangliste</h1>
       ...
       <GlassSection>
          {[
            { rank: 4, name: "Maria S.", pts: "62.5", color: "#34C759" },
            { rank: 5, name: "David L.", pts: "58.0", color: "#34C759" },
            { rank: 6, name: "Elena V.", pts: "54.2", color: "#34C759" },
          ].map((m, i) => (
             <div key={i}>
                <div className="px-5 py-4 flex items-center justify-between">
                   ...
                   <span className="text-[15px] font-bold text-[#34C759] font-mono">{m.pts}</span>
                </div>
                {i < 2 && <TLine />}
             </div>
          ))}
...
function ActivitiesScreen() {
  return (
    <div className="flex flex-col w-full gap-5 px-5 pt-4 pb-28 relative z-10">
       <div className="flex items-center justify-between px-1">
          <h1 className="text-[26px] font-bold text-white font-logo italic">Aktivitäten</h1>
...
function MoreScreen() {
  return (
    <div className="flex flex-col w-full gap-7 px-5 pt-4 pb-28 relative z-10">
       <h1 className="text-[26px] font-bold text-white font-logo italic">Mehr</h1>
       ...
       <div className="flex items-center gap-4 px-2">
          <div className="w-[60px] h-[60px] rounded-full bg-[#1A1A1A] border border-[#242424] flex items-center justify-center relative">
             <span className="text-[22px] font-logo italic text-white">PW</span>
       ...
       <div className="flex flex-col gap-3">
          {[
            { icon: <BarChart3 size={20} />, title: "Export", sub: "CSV & PDF Berichte", color: "#34C759" },
