    ...
    <div className="relative min-h-screen">
      <div className="relative z-10 max-w-[1600px] mx-auto py-8 px-6 lg:px-10 flex flex-col gap-8">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center justify-between border-b border-black/5 pb-8 mb-2">
            <div className="flex flex-col gap-2">
              <h1 className="text-4xl font-poppins font-black text-[#0A0A0A] tracking-tighter">Tätigkeiten</h1>
