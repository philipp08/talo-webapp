...
import {
  ...
  ChevronDown, Check, Calendar, Layers,
} from "lucide-react";
...
function DashboardLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: "/dashboard",                label: t("nav.dashboard"),      shortLabel: t("nav.dashboard"),        icon: LayoutGrid,    show: true },
    { href: "/dashboard/eintragen",      label: t("nav.eintragen"),      shortLabel: t("nav.eintragen"),        icon: PenLine,       show: true },
    { href: "/dashboard/training",       label: t("nav.training"),       shortLabel: t("nav.training"),         icon: Calendar,      show: true },
    { href: "/dashboard/genehmigungen",  label: t("nav.genehmigungen"),  shortLabel: t("nav.antraege"),         icon: CheckSquare,   show: isAdmin },
      ...
      >
        ...
        <div className="p-5">
          ...
          >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: "#71717A" }}>
                    {isAdmin ? t("nav.role.admin") : isTrainer ? t("nav.role.trainer") : t("nav.role.member")}
                  </span>
            ...
            >
              <span className="text-xs font-bold font-poppins uppercase tracking-wider">{t("nav.logout")}</span>
              <LogOut size={13} />
            </button>
          </div>
        </div>
          ...
          <>
            ...
            >
              ...
              <div className="p-4 border-t border-black/5 space-y-2">
                ...
                >
                  <LogOut size={16} />
                  <span className="font-poppins font-semibold text-sm">{t("nav.logout")}</span>
                </button>
              </div>
            </motion.div>
          </>
              ...
              <div className="max-w-[1600px] mx-auto bg-gradient-to-r from-[#FFF0F0] to-[#FFE5E5] border border-[#FF3B30]/20 rounded-[24px] p-5 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <h3 className="font-poppins font-black text-[14px] uppercase tracking-widest text-[#FF3B30]">{t("nav.limitBanner")}</h3>
