...
export default function Navbar() {
  ...
  const menus: Menu[] = [
    ...
    },
    {
      ...
      href: "/loesungen",
      items: [
        { title: "Tischtennis-Vereine 🏓", description: "Einsätze, Rangliste & Training digital", href: "/loesungen#tischtennis" },
        { title: "Andere Sportvereine", description: "Für alle Vereinssportarten adaptierbar", href: "/loesungen#sport" },
      ],
      featured: {
        label: "FÜR TT-VEREINE",
        title: "Talo ist das digitale Zuhause für Tischtennis-Abteilungen",
        cta: "Mehr erfahren",
        ctaHref: "/loesungen#tischtennis",
      },
    },
